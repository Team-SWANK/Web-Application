...
function LearnMore() {
    ...
    return (    
        <Container className={classes.learnMoreBorder}>
            ...
            bots can be utilized by anyone who wants to spread the movement by using the appropriate hashtags (#PhotoSense) and commands.         
            </p>
        </Container> 
    ); 
}
